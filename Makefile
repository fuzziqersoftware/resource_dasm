...
BT_DECODE_SPRITE_OBJECTS=bt_decode_sprite.o ambrosia_sprites.o $(COMMON_OBJECTS)
...
RENDER_FERAZELS_WAND_LEVELS_OBJECTS=render_ferazels_wand_levels.o $(COMMON_OBJECTS)
RENDER_HARRY_LEVELS_OBJECTS=render_harry_levels.o ambrosia_sprites.o $(COMMON_OBJECTS)
...
EXECUTABLES=render_bits bt_decode_sprite macski_decompress mohawk_dasm realmz_dasm dc_dasm resource_dasm render_infotron_levels render_ferazels_wand_levels render_harry_levels render_monkey_shines_world sc2k_decode_sprite
...
render_ferazels_wand_levels: $(RENDER_FERAZELS_WAND_LEVELS_OBJECTS)
	g++ $(LDFLAGS) -o render_ferazels_wand_levels $^

render_harry_levels: $(RENDER_HARRY_LEVELS_OBJECTS)
	g++ $(LDFLAGS) -o render_harry_levels $^
