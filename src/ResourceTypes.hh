...
constexpr uint32_t RESOURCE_TYPE_SHPD = resource_type("SHPD");
constexpr uint32_t RESOURCE_TYPE_SHPT = resource_type("SHPT");
...
constexpr uint32_t RESOURCE_TYPE_stri = resource_type("stri");
constexpr uint32_t RESOURCE_TYPE_strn = resource_type("strn");
