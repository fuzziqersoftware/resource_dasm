...
struct DecompressorImplementation {
  ...
  typedef string (*decompress_fn)(const CompressedResourceHeader& header, const void* source, size_t size);
...
shared_ptr<Resource> decompress_resource(
    shared_ptr<const Resource> res, uint64_t decompress_flags, const ResourceFile* context_rf) {
