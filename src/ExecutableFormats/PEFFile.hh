...
struct PEFHeader {
  phosg::be_uint32_t magic1; // 'Joy!'
  phosg::be_uint32_t magic2; // 'peff'
  phosg::be_uint32_t arch; // 'pwpc' or 'm68k'
  phosg::be_uint32_t format_version;
  phosg::be_uint32_t timestamp;
  phosg::be_uint32_t old_def_version;
  phosg::be_uint32_t old_imp_version;
  phosg::be_uint32_t current_version;
  phosg::be_uint16_t section_count; // total section count
  phosg::be_uint16_t inst_section_count; // sections required for execution
...
struct PEFSectionHeader {
  phosg::be_int32_t name_offset; // -1 = no name
  phosg::be_uint32_t default_address;
  phosg::be_uint32_t total_size;
  phosg::be_uint32_t unpacked_size;
  phosg::be_uint32_t packed_size;
  phosg::be_uint32_t container_offset;
...
struct PEFLoaderSectionHeader {
  phosg::be_int32_t main_symbol_section_index; // -1 if no main symbol
  phosg::be_uint32_t main_symbol_offset; // offset within the section
  phosg::be_int32_t init_symbol_section_index; // -1 if no init symbol
  phosg::be_uint32_t init_symbol_offset; // offset within the section
  phosg::be_int32_t term_symbol_section_index; // -1 if no term symbol
  phosg::be_uint32_t term_symbol_offset; // offset within the section
  phosg::be_uint32_t imported_lib_count;
  phosg::be_uint32_t imported_symbol_count;
  phosg::be_uint32_t rel_section_count; // number of sections containing relocations
  phosg::be_uint32_t rel_commands_offset; // from beginning of loader section
  phosg::be_uint32_t string_table_offset; // from beginning of loader section
  phosg::be_uint32_t export_hash_offset; // from beginning of loader section
  phosg::be_uint32_t export_hash_power; // number of entries is 2^export_hash_power
  phosg::be_uint32_t exported_symbol_count;
} __attribute__((packed));
...
struct PEFLoaderImportLibrary {
  phosg::be_uint32_t name_offset; // from beginning of loader string table
  phosg::be_uint32_t old_imp_version;
  phosg::be_uint32_t current_version;
  phosg::be_uint32_t imported_symbol_count; // number of symbols imported from this lib
  phosg::be_uint32_t start_index; // first import's index in imported symbol table
...
struct PEFLoaderRelocationHeader {
  phosg::be_uint16_t section_index;
  phosg::be_uint16_t reserved;
  // Some relocation commands are multiple words, so this isn't necessarily the
  // same as the command count
  phosg::be_uint32_t word_count;
  phosg::be_uint32_t start_offset;
} __attribute__((packed));
...
struct PEFLoaderExportHashKey {
  phosg::be_uint16_t symbol_length;
  phosg::be_uint16_t hash;
} __attribute__((packed));

struct PEFLoaderExportSymbol {
  phosg::be_uint32_t type_and_name;
  phosg::be_uint32_t value; // usually offset from section start
  phosg::be_uint16_t section_index;
