...
struct PDHeader {
  phosg::be_uint16_t format_version;
  phosg::be_uint32_t unknown_a1_offset;
  phosg::be_uint32_t image_metas_offset;
  phosg::be_uint32_t image_data_offset;
  phosg::be_uint32_t image_data_size;
  uint8_t unknown_a2[4];
  phosg::be_uint16_t num_color_table_entries;
} __attribute__((packed));

struct PDUnknownA1Entry {
  phosg::be_uint16_t format;
  phosg::be_uint16_t unknown_a1;
  phosg::be_uint16_t image_number;
  phosg::be_uint16_t unknown_a2[5];
  phosg::be_uint32_t unknown_a3[4];
} __attribute__((packed));

struct PDImageMetaEntry {
  phosg::be_uint32_t data_offset; // Relative to image_data_offset
...
std::vector<phosg::ImageRGBA8888N> decode_pathways_256(const std::string& data) {
  ...
  phosg::StringReader image_metas_r = r.sub(
      header.image_metas_offset, header.image_data_offset - header.image_metas_offset);
  phosg::StringReader unknown_a1s_r = r.sub(
      header.unknown_a1_offset, header.image_data_offset - header.unknown_a1_offset);
  phosg::StringReader image_data_r = r.sub(header.image_data_offset, header.image_data_size);
  ...
  while (!image_metas_r.eof()) {
    ...
    // It seems format 6 has data in row-major order, while all other formats have data in column-major order.
    if (format == 6) {
...
struct MHeader {
  phosg::be_uint16_t format_version;
  phosg::be_uint16_t unknown_a0;
  phosg::be_uint16_t unknown_a1; // Must be zero apparently?
  phosg::be_uint16_t num_color_table_entries;
  phosg::be_uint16_t unknown_a2;
  phosg::be_uint32_t color_table_offset;
  phosg::be_uint16_t num_name_entries;
  phosg::be_uint32_t name_offset_table_offset;
  phosg::be_uint16_t num_metadata_headers;
  phosg::be_uint32_t metadata_headers_offset_table_offset;
  phosg::be_uint16_t num_images;
  phosg::be_uint32_t image_data_offsets_table_offset;
  phosg::be_uint16_t unknown_a4;
  phosg::be_uint32_t total_size;
} __attribute__((packed));

struct MMetadataHeader {
  phosg::be_uint32_t unknown_a1;
  phosg::be_uint32_t image_number;
  uint8_t unknown_a2[10];
  phosg::be_uint16_t width;
  phosg::be_int16_t height; // Can be negative!
...
struct MImageHeader {
  phosg::be_uint16_t width;
  phosg::be_uint16_t height;
  phosg::be_uint16_t row_bytes; // May be FFFF if image is compressed
  phosg::be_uint32_t unknown_a2;
  uint8_t unknown_a3[0x10];
  // Variable-length fields:
  // phosg::be_uint16_t unknown_a4[height][2];
...
std::vector<phosg::ImageRGBA8888N> decode_marathon_256(const std::string& data) {
  ...
  while (ret.size() < header.num_images) {
    ...
    phosg::StringReader alpha_r;
    phosg::StringReader data_r;
    ...
    if (image_header.row_bytes == 0xFFFF) {
      ...
      alpha_r = phosg::StringReader(alpha_data);
      data_r = phosg::StringReader(decompressed_data);
