...
int main(int argc, char** argv) {
  ...
  auto decoded = ResourceDASM::parse_applesingle_appledouble(phosg::load_file(input_filename));
  ...
  phosg::fwritex(rsrc_f.get(), serialize_resource_fork(decoded.resource_fork));
  return 0;
}
